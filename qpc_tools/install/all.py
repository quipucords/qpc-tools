...
class InstallAllCommand(CliCommand):
    ...
    def __init__(self, subparsers):
        ...
        self.parser.add_argument('--offline', dest='offline',
                                 ...
                                 default='false',
                                 help=_(messages.ALL_INSTALL_OFFLINE_HELP),
                                 required=False)
        self.parser.add_argument('--offline-files', dest='offline_files',
                                 help=_(messages.ALL_INSTALL_OFFLINE_FILES_HELP),
                                 required=False)
        self.parser.add_argument('--server-version', dest='server_version',
                                 default='latest',
                                 help=_(messages.SERVER_INSTALL_VERSION_HELP),
                                 required=False)
        self.parser.add_argument('--cli-version', dest='cli_version',
                                 default='latest',
        ...
        self.parser.add_argument('--password', dest='password',
                                 ...
                                 required=True)
        self.parser.add_argument('--cli-advanced', dest='cli_advanced',
                                 help=SUPPRESS,
                                 required=False)
        self.parser.add_argument('--server-advanced', dest='server_advanced',
                                 help=SUPPRESS,
                                 required=False)
